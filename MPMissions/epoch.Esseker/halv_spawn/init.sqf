...
if(isServer)then{
	...
	_objecttexture = "halv_spawn\menu.jpg";
	...
	// Use picture, picture fullname
	_northWall = [true,"halv_spawn\fearloadscrn.jpg"];
	_eastWall = [false,""];
	_southWall = [false,""];
	_westWall = [false,""];
	...
	_alltextures = [
		[_northWall select 0,_northWall select 1,[-0.4,10,-4],0],
		[_eastWall select 0,_eastWall select 1,[16.5,.4,-4],90],
		[_southWall select 0,_southWall select 1,[-0.4,-9.5,-4],180],
		[_westWall select 0,_westWall select 1,[-17.2,.1,-4],270]
	];
