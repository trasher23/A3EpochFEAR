...
[] spawn {
	...
	while {true} do
	{
		...
		[
			"DAMAGE: %1 | HUNGER: %2 |  THIRST: %3 | STAMINA: %4 | KRYPTO: %5 | FPS: %6 | PLAYERS: %7",
			_damage, EPOCH_playerHunger, EPOCH_playerThirst, round EPOCH_playerStamina, EPOCH_playerCrypto, round diag_fps, count playableUnits
		];
	}; 
};