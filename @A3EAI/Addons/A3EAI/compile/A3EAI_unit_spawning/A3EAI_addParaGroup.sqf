...
0 = [5,_trigger,[_unitGroup],PATROL_DIST_PARAGROUP,_unitLevel,[_unitsAlive,0]] call A3EAI_initializeTrigger;
...
0 = [_paraGroup,_startPos,PATROL_DIST_PARAGROUP] spawn A3EAI_BIN_taskPatrol;
