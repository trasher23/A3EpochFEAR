...
EPOCH_server_hiveSETBIT          = compileFinal preprocessFileLineNumbers "\x\addons\a3_epoch_server\compile\epoch_hive\EPOCH_server_hiveSETBIT.sqf";
EPOCH_server_hiveSETEX           = compileFinal preprocessFileLineNumbers "\x\addons\a3_epoch_server\compile\epoch_hive\EPOCH_server_hiveSETEX.sqf";
EPOCH_server_hiveEXPIRE          = compileFinal preprocessFileLineNumbers "\x\addons\a3_epoch_server\compile\epoch_hive\EPOCH_server_hiveEXPIRE.sqf";
EPOCH_server_hiveLog             = compileFinal preprocessFileLineNumbers "\x\addons\a3_epoch_server\compile\epoch_hive\EPOCH_server_hiveLog.sqf";
...
EPOCH_server_hiveGETRANGE        = compileFinal preprocessFileLineNumbers "\x\addons\a3_epoch_server\compile\epoch_hive\EPOCH_server_hiveGETRANGE.sqf";
EPOCH_server_hiveGETBIT          = compileFinal preprocessFileLineNumbers "\x\addons\a3_epoch_server\compile\epoch_hive\EPOCH_server_hiveGETBIT.sqf";
EPOCH_server_hiveGETTTL          = compileFinal preprocessFileLineNumbers "\x\addons\a3_epoch_server\compile\epoch_hive\EPOCH_server_hiveGETTTL.sqf";
