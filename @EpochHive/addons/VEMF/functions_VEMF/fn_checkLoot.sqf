...
_aiGear = [["VEMFconfig","aiGear"],["aiUniforms","aiHeadGear","aiVests","aiBackpacks","aiLaunchers","aiItems","aiRifles","aiPistols"]] call VEMF_fnc_getSetting;
{
    {
...
_loot = [["VEMFconfig","crateLoot"],["primaryWeaponLoot","secondaryWeaponLoot","magazinesLoot","attachmentsLoot","itemsLoot","vestsLoot","backpacksLoot","headGearLoot"]] call VEMF_fnc_getSetting;
{
    {
        _class = _x select 0;
