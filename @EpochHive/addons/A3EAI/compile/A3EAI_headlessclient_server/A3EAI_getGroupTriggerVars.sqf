...
_triggerVars = [[_unitGroup,_trigger]];
...
if (A3EAI_debugLevel > 1) then {diag_log format ["A3EAI Extended Debug: Retrieved group %1 trigger variables: %2",_unitGroup,_triggerVars];};
